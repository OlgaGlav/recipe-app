package by.glavdel.recipeapp.bootstrap;

import by.glavdel.recipeapp.domain.*;
import by.glavdel.recipeapp.repositories.CategoryRepository;
import by.glavdel.recipeapp.repositories.RecipeRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    //sometimes we have hibernate.LazyInitializationException
    @Transactional
